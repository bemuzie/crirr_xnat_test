...
public class XnatPetmrsessiondataBean extends XnatImagesessiondataBean implements java.io.Serializable, org.nrg.xdat.model.XnatPetmrsessiondataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatPetmrsessiondataBean.class);
	...
	/**
	 * Sets the value for xnat:petmrSessionData/tracer/transmissions.
	 * @param v Value to Set.
	 */
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		//REFERENCE FROM petmrSessionData -> imageSessionData
		if (_Coil!=null){
