...
public class XnatProjectparticipantBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.XnatProjectparticipantI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatProjectparticipantBean.class);
	...
	public void setDataField(String xmlPath,String v) throws BaseElement.UnknownFieldException{
		if (xmlPath.equals("label")){
			...
			setProject(v);
		}else if (xmlPath.equals("subject_ID")){
			setSubjectId(v);
	...
	protected TreeMap getXMLAtts() {
		...
		if (_SubjectId!=null)
			map.put("subject_ID",ValueParser(_SubjectId,"string"));
		//NOT REQUIRED FIELD
