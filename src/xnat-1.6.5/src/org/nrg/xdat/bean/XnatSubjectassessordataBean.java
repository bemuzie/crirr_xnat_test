...
public class XnatSubjectassessordataBean extends XnatExperimentdataBean implements java.io.Serializable, org.nrg.xdat.model.XnatSubjectassessordataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatSubjectassessordataBean.class);
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		//REFERENCE FROM subjectAssessorData -> experimentData
		if (_SubjectId!=null){
		...
		if (_Age!=null){
			...
			writer.write(">");
			writer.write(ValueParser(_Age,"float"));
