...
public class ArcPropertyBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.ArcPropertyI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ArcPropertyBean.class);
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Property!=null){
			writer.write(ValueParser(_Property,"string"));
			header--;
		}
	return false;
	}
