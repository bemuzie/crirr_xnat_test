...
public class WrkXnatexecutionenvironmentNotifyBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.WrkXnatexecutionenvironmentNotifyI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(WrkXnatexecutionenvironmentNotifyBean.class);
	...
	public void setWrkXnatexecutionenvironmentNotifyId(Integer v){
		_WrkXnatexecutionenvironmentNotifyId=v;
	}
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Notify!=null){
			writer.write("\n" + createHeader(header++) + "<wrk:notify");
			writer.write(">");
			writer.write(ValueParser(_Notify,"string"));
			writer.write("</wrk:notify>");
			header--;
		}
	return true;
	}
