...
public class XnatStatisticsdataAdditionalstatisticsBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.XnatStatisticsdataAdditionalstatisticsI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatStatisticsdataAdditionalstatisticsBean.class);
	 ...
	 * @param v Value to Set.
	 */
	public void setAdditionalstatistics(String v)  {
		_Additionalstatistics=formatDouble(v);
	}
	...
	public void setXnatStatisticsdataAdditionalstatisticsId(Integer v){
		_XnatStatisticsdataAdditionalstatisticsId=v;
	}
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Additionalstatistics!=null){
			writer.write(ValueParser(_Additionalstatistics,"double"));
			header--;
		}
	return false;
	}
	...
	protected boolean hasXMLBodyContent(){
		if (_Additionalstatistics!=null) return true;
