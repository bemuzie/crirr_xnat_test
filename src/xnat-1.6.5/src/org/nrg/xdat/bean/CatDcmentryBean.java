...
public class CatDcmentryBean extends CatEntryBean implements java.io.Serializable, org.nrg.xdat.model.CatDcmentryI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CatDcmentryBean.class);
	...
	public void setDataField(String xmlPath,String v) throws BaseElement.UnknownFieldException{
		if (xmlPath.equals("UID")){
			setUid(v);
		}else if (xmlPath.equals("instanceNumber")){
			setInstancenumber(v);
		}
		else{
	...
	protected TreeMap getXMLAtts() {
		...
		if (_Instancenumber!=null)
			map.put("instanceNumber",ValueParser(_Instancenumber,"integer"));
		//NOT REQUIRED FIELD
