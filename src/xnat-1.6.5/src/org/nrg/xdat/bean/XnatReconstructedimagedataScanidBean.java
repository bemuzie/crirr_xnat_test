...
public class XnatReconstructedimagedataScanidBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.XnatReconstructedimagedataScanidI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatReconstructedimagedataScanidBean.class);
	...
	public void setXnatReconstructedimagedataScanidId(Integer v){
		_XnatReconstructedimagedataScanidId=v;
	}
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Scanid!=null){
			writer.write("\n" + createHeader(header++) + "<xnat:scanID");
			writer.write(">");
			writer.write(ValueParser(_Scanid,"string"));
			writer.write("</xnat:scanID>");
			header--;
		}
	return true;
	}
