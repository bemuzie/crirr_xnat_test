...
public class CatCatalogTagBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.CatCatalogTagI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(CatCatalogTagBean.class);
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Tag!=null){
			writer.write("\n" + createHeader(header++) + "<cat:tag");
			writer.write(">");
			writer.write(ValueParser(_Tag,"string"));
			writer.write("</cat:tag>");
			header--;
		}
	return true;
	}
