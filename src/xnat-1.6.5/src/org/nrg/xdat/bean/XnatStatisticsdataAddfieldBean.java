...
public class XnatStatisticsdataAddfieldBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.XnatStatisticsdataAddfieldI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XnatStatisticsdataAddfieldBean.class);
	...
	public void setXnatStatisticsdataAddfieldId(Integer v){
		_XnatStatisticsdataAddfieldId=v;
	}
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Addfield!=null){
			writer.write(ValueParser(_Addfield,"string"));
			header--;
		}
	return false;
	}
