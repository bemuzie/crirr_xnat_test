...
public class PrearcUtils {
	...
	public static boolean canModify(final XDATUser user, final String projectId) throws Exception {
		return user.checkRole(PrearcUtils.ROLE_SITE_ADMIN) || projectId != null && user.hasAccessTo(projectId);
	}
	 ...
	 *             does not exist.
	 */
	public static File getPrearcDir(final XDATUser user, final String project, final boolean allowUnassigned) throws Exception {
		String prearcPath;
		if(project==null || project.equals(COMMON)){
			...
			if(p!=null){
				if (user!=null && !user.hasAccessTo(project)) {
	...
	public static File getPrearcSessionDir(final XDATUser user, final String project, final String timestamp,final String session, final boolean allowUnassigned) throws Exception {
    ...
    public static void resetStatus(final XDATUser user, final String project, final String timestamp, final String session, final boolean allowUnassigned) throws Exception {
    ...
    public static void resetStatus(final XDATUser user,final String project, final String timestamp, final String session,final String uID, final boolean allowUnassigned) throws Exception {
		SessionData deleted = null;
		try {
			deleted = PrearcDatabase.getSession(session,timestamp,project);
			PrearcDatabase.unsafeSetStatus(session, timestamp, project, PrearcStatus._DELETING);
	...
	public static void addSession(final XDATUser user,final String project, final String timestamp, final String session,final boolean allowUnassigned) throws Exception {
		addSession(user,project,timestamp,session,null,allowUnassigned);
	}
	
	public static void addSession(final XDATUser user,final String project, final String timestamp, final String session, final String uID,final boolean allowUnassigned) throws Exception {
