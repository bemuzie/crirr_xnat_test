            ...
            if (sessionXml.exists()) {
                ...
                if (bean instanceof XnatPetmrsessiondataBean) {
                    ...
                    for (final String modality : sessions.keySet()) {
                        ...
                        final PrearcImporterA.PrearcSession session = new PrearcImporterA.PrearcSession(sessionData.getProject(), sessionData.getTimestamp(), sessionData.getFolderName(), null, (XDATUser) getUser());
