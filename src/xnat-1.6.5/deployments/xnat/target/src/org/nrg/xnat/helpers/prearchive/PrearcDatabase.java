...
public final class PrearcDatabase {
    ...
    private static Map<String, SessionData> _separatePetMrSession(final String session, final String timestamp, final String project, final XnatPetmrsessiondataBean petmrSession) throws Exception {
        ...
        final XDATUser importer = provider.get();
    ...
    static String getUniqueSessionLabel(final String stem, final String target, final String replacement, final String projectId, final XDATUser user) {
        String label;
     ...
     * @throws IllegalStateException
     */
    public static Map<SessionDataTriple, Boolean> archive(final List<PrearcSession> sessions, final Boolean overrideExceptions, final Boolean allowSessionMerge, final Boolean overwriteFiles, final XDATUser user, final Set<StatusListenerI> listeners) throws Exception {
