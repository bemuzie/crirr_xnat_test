    ...
    public void handlePut() {
        try {
            ...
            if (filepath != null && !filepath.equals("")) {
                    ...
                    if (newProject != null) {
                        ...
                        if (getQueryVariable("primary") != null && getQueryVariable("primary").equals("true")) {
                            ...
                            if (matched == null) {
                                ...
                                if (user.canCreate(_experiment.getXSIType() + "/project", newProject.getId())) {
                ...
                if (user.canEdit(_experiment.getItem())) {
