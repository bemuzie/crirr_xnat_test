...
public class XnatPipelineLauncher {
    ...
    public static XnatPipelineLauncher GetLauncherForProject(RunData data, Context context, XnatProjectdata project) throws Exception {
        XnatPipelineLauncher xnatPipelineLauncher = new XnatPipelineLauncher(data, context);
        xnatPipelineLauncher.setSupressNotification(true);
        UserI user = TurbineUtils.getUser(data);
        xnatPipelineLauncher.setParameter("useremail", user.getEmail());
        ...
        xnatPipelineLauncher.setId(project.getId());
        xnatPipelineLauncher.setLabel(project.getId());
        xnatPipelineLauncher.setDataType(project.getXSIType());
        xnatPipelineLauncher.setExternalId(project.getId());
        xnatPipelineLauncher.setParameter("project", project.getId());
    ...
    public static XnatPipelineLauncher GetLauncher(RunData data, Context context, XnatProjectdata project) throws Exception {
        XnatPipelineLauncher xnatPipelineLauncher = GetLauncherForProject(data, context, project);
        return xnatPipelineLauncher;
    }
